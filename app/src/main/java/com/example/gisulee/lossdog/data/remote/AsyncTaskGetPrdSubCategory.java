...
public class AsyncTaskGetPrdSubCategory extends AsyncTask<String, Void, Void> {
    ...
    public AsyncTaskGetPrdSubCategory(Resources res,ArrayList<NameCode> arrayList) {
        this.resources = res;
        this.arrayList = arrayList;
    }

    public AsyncTaskGetPrdSubCategory setOnTaskWorkStateListener(OnTaskWorkStateListener onTaskWorkStateListener){
    ...
    protected Void doInBackground(String... strings) {
        ...
        try {
         /*   URL url = new URL(queryUrl);
            ...
            XmlPullParser xmlPullParser = resources.getXml(R.xml.prd_sub_code);
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                switch (eventType) {
                    case XmlPullParser.START_TAG:
                        ...
                        else if(tag.equals("hiPrdtCd"))
                            highCode = xmlPullParser.nextText();
                    ...
                    case XmlPullParser.END_TAG:
                        ...
                        if (tag.equals("item")) {
                            Log.d("ss", "doInBackground: highcode" + highCode);
                            Log.d("ss", "doInBackground: " + itemCode);
                            if(highCode.equals(itemCode)) {
                                arrayList.add(item);
                            }
                        }
                        break;
