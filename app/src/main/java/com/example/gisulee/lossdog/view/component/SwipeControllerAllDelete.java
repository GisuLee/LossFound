...
class SwipeControllerAllDelete extends ItemTouchHelper.Callback {
    ...
    public SwipeControllerAllDelete(Resources res, SwipeControllerActions buttonsActions) {
        this.res = res;
        ...
        recyclerView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    SwipeControllerAllDelete.super.onChildDraw(c, recyclerView, viewHolder, 0F, dY, actionState, isCurrentlyActive);
                    recyclerView.setOnTouchListener(new View.OnTouchListener() {
                        @Override
                        public boolean onTouch(View v, MotionEvent event) {
                            return false;
    ...
    private void drawButtons(Canvas c, RecyclerView.ViewHolder viewHolder) {
        ...
        Paint p = new Paint();
        RectF backGround = new RectF(itemView.getLeft(), itemView.getTop(), viewHolder.itemView.getWidth(), itemView.getBottom());
        ...
        BitmapDrawable bd = (BitmapDrawable)res.getDrawable(R.drawable.img_delete);
        Bitmap bit = createScaledBitmap(bd.getBitmap(),100,100,false);
        drawText("삭제", c, leftButton, p,bit);
